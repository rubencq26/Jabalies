...
Implementar un atributo "atracción/rechazo" de los ciudadanos neutrales hacia los jabalíes cuando se los encuentran en la zona urbana, de forma análoga a cómo ocurriría en un núcleo urbano ante la presencia de un animal silvestre, donde una fracción de los transeúntes rehuiría del potencial encuentro mientras otra, curiosa, intentaría provocarlo. Estudiar cómo este comportamiento puede afectar a la dinámica de la frontera.

Implementar las dinámicas demográficas de los ciudadanos dentro de la zona urbana. La descendencia de un determinado individuo podría heredar parte de sus atributos con cierto margen de aleatoriedad (análogo a la variabilidad genética y contextual) y la tasa de reproducción podría ser un parámetro fijo o estar derivada de la evolución del sistema. Algunas formas de enfocarlo son: 

  1. Plantear un atributo de "bienestar" general (con margen de aleatoriedad o no), que se vea influenciado por las incursiones de los jabalíes dentro de la ciudad y la densidad de población actual, por debajo de cierto umbral la reproducción se ve limitada o inhibida.

  2. Directamente dependiente de la densidad de población (a discreción del programador si la correlación es positiva, a más personas más encuentros; o negativa, a mayor densidad, menos recursos).

Ampliar la complejidad del medio natural. Se pueden implementar otras posibles presas de sus depredadores naturales, aun siendo estas genéricas (sin concretar especie), para estudiar cómo la evolución del comportamiento de los jabalíes puede afectar a la estabilidad del ecosistema --y no sólo estudiar este fenómeno desde la perspectiva urbana--. 

También se pueden afinar las dinámicas de reproducción de las plantas, para estudiar como su población podría desestabilizar el ecosistema si los jabalíes migran de una alimentación herbívora a una detritívora oportunista. Para estudiar esos fenómenos sería recomendable implementar algún mecanismo de saciedad mediante el que un jabalí que ha consumido basura en la zona urbana pierda el interés en su alimento natural.

Remodelar la dinámica de la frontera. Actualmente solo tiene en cuenta la presencia o no de sendas razas, jabalíes y ciudadanos, en la linde. Podría tener en cuenta datos más globales, como la población total de personas, o algún mecanismo de arraigo en el que los ciudadanos tengan un lugar (modelado con los patches) que asuman como su casa y ante la presencia de jabalíes en la zona la probabilidad de que migren a otros "barrios" más alejados de la linde se incrementa, haciendo que poco a poco las decisiones individuales sean las que provocan el estrechamiento de la zona urbana. 



## CREDITS AND REFERENCES

Varios artículos periodísticos y oficiales sobre la situación actual con respecto a jabalíes en municipios con alta densidad poblacional:

Dos siniestros casi simultáneos con jabalíes en el área coruñesa dejan a dos personas heridas. La Voz de Galicia: https://www.lavozdegalicia.es/noticia/coruna/2026/03/04/dos-siniestros-simultaneos-jabalies-area-corunesa-dejan-dos-personas-heridas/00031772655550828575214.htm

Abaten al jabalí que se había colado en el metro de València provocando retrasos generalizados. La Ser:
https://cadenaser.com/comunitat-valenciana/2026/02/05/la-presencia-de-un-jabali-en-las-vias-del-metrovalencia-provoca-retrasos-en-las-lineas-1-y-2-radio-valencia/

Madrid prevé superar las 10.000 capturas de jabalíes para frenar accidentes y daños al campo. El Diario de Madrid: https://www.eldiariodemadrid.es/articulo/medio-ambiente/madrid-superara-10000-capturas-jabalies-temporada-2025-2026-control-poblacion/20260110134114117981.html

La Junta declara la emergencia cinegética del jabalí para reducir daños, riesgos sanitarios y ambientales y de seguridad que provoca la superpoblación. Consejería de Sostenibilidad y Medio Ambiente de la Junta de Andalucía: https://www.juntadeandalucia.es/organismos/sostenibilidadymedioambiente/servicios/actualidad/noticias/detalle/592624.html
